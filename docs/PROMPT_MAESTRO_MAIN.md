...
Corrección de secuencia actualizada el 18 de agosto de 2026: el Calendario en consulta/edición y los controles explícitos de visibilidad de Notificaciones están integrados en `main`. Perfil laboral y la reorganización acotada de Configuración quedaron implementados y auditados en `codex/guard-profile-settings`, partiendo de `71ffd148e1662a148c1d9c306e4321652ef65bbb`; su promoción todavía requiere autorización. Después de establecer esa rama como nueva base canónica, el siguiente incremento habilitado es bienvenida, onboarding, primera carga y Ayuda. No se reabre ni amplía Notificaciones.

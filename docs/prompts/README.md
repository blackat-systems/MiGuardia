...
| `REGLAS_DOMINIO_CONFIGURACION_Y_HORAS_V2.md` | **HABILITADO** | Primer bloque activo: reglas puras de sector, vigencia por fecha y referencias de horas, sin Room ni pantallas |
...
contrato ya está habilitado; los siguientes nacen únicamente cuando su
dependencia anterior esté cerrada:

1. Room v6 y configuración inicial;

...
class CalendarComposeTest {
    ...
    fun gridShowsEveryStateAndDayDetailKeepsMultipleShiftsAccessible() {
        ...
        composeRule.onNodeWithText("2 turnos", useUnmergedTree = true).assertExists()
        composeRule.onNodeWithText("DOS", useUnmergedTree = true).assertDoesNotExist()
        composeRule.onNodeWithText("TRE", useUnmergedTree = true).assertDoesNotExist()
        composeRule.onNodeWithText("+1", useUnmergedTree = true).assertDoesNotExist()
